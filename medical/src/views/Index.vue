...
<!--        <img src="https://www.itheima.com/images/logo.png" style="float: left;" @click="getMenus" alt="icon"/>-->
        <img src="../images/gl.png" style="float: left;" @click="getMenus" alt="icon"/>
        ...
        <!-- <el-row :gutter="20">
          <el-col :span="4">
            <div class="grid-content bg-purple" @click="getMenus">
        ...
        <el-aside :collapse="isCollapse" height=" 100%" width="250px" @close="handleClose" @open="handleOpen">
          <!--<div class="myMenu">
              ...
              >
                <el-submenu index="/movie">
                  ...
                  <el-menu-item-group>
                    <el-menu-item index="/movie/findall">管理电影</el-menu-item>
                    <el-menu-item index="/movie/add">增加电影</el-menu-item>
                    <el-menu-item index="/movie/find">查找电影</el-menu-item>
                    <el-menu-item index="/movie/editcategorymovie"
                      >电影类型</el-menu-item
                    >
                    <el-menu-item index="/movie/test">测试电影</el-menu-item>
                  </el-menu-item-group>
                </el-submenu>
                <el-submenu index="/category">
                  ...
                  <el-menu-item-group>
                    <el-menu-item index="/category/manage">类型管理</el-menu-item>
                    <el-menu-item index="/category/add">添加类型</el-menu-item>
                  </el-menu-item-group>
                </el-submenu>
                <el-submenu index="/schedule">
                  ...
                  <el-menu-item-group>
                    <el-menu-item index="/schedule/manage">场次管理</el-menu-item>
                    <el-menu-item index="/schedule/add">场次添加</el-menu-item>
                  </el-menu-item-group>
                </el-submenu>
                <el-submenu index="4">
                  <template slot="title">
          ...
          <!-- <el-menu>
              ...
              >
                ...
                <el-menu-item v-for="menu2 in menu.menuDTO" :key="menu2.rightId">
...
export default {
  data () {
    return {
      sizeList: '',
      menusList: [],
      circleUrl: mystore.state.user.userAvatarUrl,
      userName: mystore.state.user.userName,
      isCollapse: true
    }
  },
  beforeRouteEnter (to, from, next) {
    // if (mystore.state.user.userId) {
    if (mystore.state.user.token) {
      next()
    } else {
      next('/login')
    }
  ...
  methods: {
    ...
    getMenus () {
      console.log('准备查询roleId为' + mystore.state.user.roleId)
      axios({
        method: 'get',
        url: '/admin/right/menus',
        data: Qs.stringify(mystore.state.user)
      }).then((jsondata) => {
        this.menusList = jsondata.data
        console.log(jsondata)
        if (jsondata.code === '308') {
          console.log('token失效')
