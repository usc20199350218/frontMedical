  ...
  <div>
    <div>
      <el-input v-model="searchText" class="input-with-select" placeholder="请输入内容">
        <el-select slot="prepend" v-model="searchMethod" placeholder="请选择" style="width: 150px;">
    ...
    <div>
      <el-dialog :before-close="handleClose" :title="titText" :visible.sync="showEdit" width="30%">
