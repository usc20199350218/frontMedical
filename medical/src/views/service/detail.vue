  ...
  <div>
    <div>
      <el-row :span="24">
        ...
        <el-col :span="1.2">
          <el-button v-if="editService" @click="editServiceF()">编辑</el-button>
        </el-col>
        <el-col :span="1.2">
          <el-button v-if="!editService" @click="save()">保存</el-button>
        </el-col>
        <el-col :span="1.2">
    ...
    <div>
      ...
      <el-table :data="serviceList" style="width: 100%">
        <el-table-column label="随访项" prop="serviceEntryName" width="180">
        </el-table-column>
