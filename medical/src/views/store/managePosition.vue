  ...
  <div>
    <div>
      <el-table :data="
        ...
        <el-table-column fixed="left" label="职位ID" min-width="80px">
        ...
        <el-table-column fixed="left" label="职位名称" min-width="80px">
          <template slot-scope="positionList">
        ...
        <el-table-column fixed="left" label="标准薪水" min-width="80px">
          <template slot-scope="positionList">
        ...
        <el-table-column align="left" fixed="right" width="220px">
          <template slot="header" slot-scope="positionList">
            ...
            <el-button icon="el-icon-circle-plus-outline" round size="mini" type="primary"
                       @click="position = {}, showAdd = true">添加
            </el-button>
          </template>
          <template slot-scope="positionList">
    ...
    <div>
      <el-dialog :visible.sync="showAdd" title="新增职位">
        <el-form ref="form" :model="position" label-width="80px" size="mini">
          <el-form-item label="职位名称">
            <el-col :span="10">
              <el-input v-model="position.positionName" maxlength="32" show-word-limit
                        type="textarea"></el-input>
            </el-col>
          </el-form-item>
          <el-form-item label="标准薪水">
            <el-col :span="10">
              <el-input v-model="position.salary" maxlength="10" show-word-limit
                        type="text"></el-input>
            </el-col>
          </el-form-item>
          <el-form-item label="职责">
            <el-col :span="10">
              <el-input v-model="position.responsibility" maxlength="32" show-word-limit
                        type="textarea"></el-input>
            </el-col>
          </el-form-item>
        </el-form>
    ...
    <div>
      <el-dialog :visible.sync="showUpd" title="新增职位">
        <el-form ref="form" :model="position" label-width="80px" size="mini">
          <el-form-item label="职位名称">
            <el-col :span="10">
              <el-input v-model="position.positionName" maxlength="32" show-word-limit
