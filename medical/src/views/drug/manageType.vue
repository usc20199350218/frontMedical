  ...
  <div>
    <div>
      <el-table :data="
        ...
        <el-table-column fixed="left" label="品类ID" min-width="80px">
        ...
        <el-table-column fixed="left" label="创建" min-width="80px">
          <template slot-scope="typeList">
            <span style="margin-left: 10px">{{ typeList.row.createTime }}</span>
          </template>
        </el-table-column>
        <el-table-column fixed="left" label="更新" min-width="80px">
          <template slot-scope="typeList">
        ...
        <el-table-column align="left" fixed="right" width="220px">
          <template slot="header" slot-scope="typeList">
            <el-col :span="14">
              <el-input v-if="typeList" v-model="search" placeholder="输入关键字搜索" size="mini"/>
            </el-col>
      ...
      <el-dialog :title="tit" :visible.sync="showDialog">
        <el-form ref="form" :model="type" label-width="100px" size="mini">
          <el-form-item label="品类名称）">
            <el-col>
              <el-input v-model="type.typeName" maxlength="20" placeholder="请输入名称）" show-word-limit
                        type="text">
              </el-input>
            </el-col>
          </el-form-item>
